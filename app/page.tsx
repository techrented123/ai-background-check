              ...
              >
                <div className="flex items-center justify-end mb-2 md:mb-4">
                  ...
                  <button
                    ...
                    className="hidden md:inline-flex cursor-pointer items-center space-x-1 rounded-full border border-emerald-700 text-emerald-700 bg-green-100 px-3 py-1.5 text-xs md:text-sm shadow-sm hover:bg-emerald-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-emerald-500 transition-all duration-200"
                    aria-label={
                      isFormCollapsed
                        ? "Expand form panel"
                        : "Collapse form panel"
